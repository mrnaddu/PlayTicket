...
namespace PlayTicket.Blazor.Server.Menus;

public class PlayTicketMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public PlayTicketMenuContributor(IConfiguration configuration)
    {
